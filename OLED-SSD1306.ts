/**
  * OLED SSD1306 Display Block
  */
//% color="#275C6B" weight=83 icon="\uf109" block="JoyPi Advanced"
namespace JoyPiAdvanced {
    ...
    //% block="Draw line from x: %x0 and y: %y0 to x: %x1 and y: %y1"
    //% subcategory="OLED Display"
    //% weight=70
    ...
    //% block="Draw rectangle at x: %x0 and y: %y0 with width: %width and height: %height"
    //% subcategory="OLED Display"
    //% weight=60
    ...
    //% block="Draw circle at x: %x and y: %y with radius: %radius"
    //% subcategory="OLED Display"
    //% weight=50
